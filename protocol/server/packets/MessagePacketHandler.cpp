...
const void MessagePacketHandler::handle(Packet &packet, std::shared_ptr<ServerManager> serverManager, IoClient *origin) const {
    try {
...
const std::string MessagePacketHandler::_trim(const std::string& s) const {
